...
SELECT COUNT(*) AS "episode_count" FROM "episodes" WHERE "air_date" BETWEEN '2018-01-01' AND '2023-12-31';
...
SELECT COUNT(*) AS "episode_count" FROM "episodes" WHERE air_date BETWEEN '2002-01-01' AND '2007-12-31';
...
SELECT "title" FROM "episodes" WHERE "season" = 1 OR "season" = 2;
